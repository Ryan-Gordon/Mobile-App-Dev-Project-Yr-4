...
namespace CryptoFolio.ViewModels
{
    public class ShellViewModel : ViewModelBase
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(new ShellNavigationItem("Shell_Main".GetLocalized(), Symbol.SolidStar, typeof(MainViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_Login".GetLocalized(), Symbol.Next, typeof(LoginViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_AddCoin".GetLocalized(), Symbol.NewWindow, typeof(AddCoinViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_Chart".GetLocalized(), Symbol.Page, typeof(ChartViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_News".GetLocalized(), Symbol.World, typeof(NewsPageViewModel).FullName));
